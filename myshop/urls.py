...
urlpatterns = [
    ...
    path('checkout/step/<int:step>/', book_views.checkout, name='checkout_step'),
    ...
    path('shipping/zasilkovna/points/', book_views.zasilkovna_pickup_points, name='zasilkovna_pickup_points'),
